...
<body>
	...
	if(isset($_POST["email"]) && isset($_POST["userpw"]))	{

	$email = $_POST["email"]; 			
	$userpw = $_POST["userpw"];		

	$checkpw=$conn->prepare("SELECT userpw FROM login WHERE email=?;");
	$checkpw->bind_param("s", $email);
	$checkpw->execute();
	$pw = $checkpw->get_result()->fetch_assoc();
			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form method="post" action="./login.php" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn" onclick="location.href='register.php'">
							Registrieren
						</button>
